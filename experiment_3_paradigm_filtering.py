...
from core.change_detection import create_improved_segments_with_confidence
...
class ParadigmFilteringExperiment:
    ...
    def __init__(self):
        self.domains = [
            'natural_language_processing', 'deep_learning', 'computer_vision',
            'machine_learning', 'machine_translation', 'computer_science',
            'art', 'applied_mathematics'
        ]
    ...
    def _run_filtering_test(self, domain_data: DomainData, condition: FilteringCondition) -> Dict:
        ...
        standard_signals, _ = detect_shift_signals(domain_data, domain_data.domain_name)
        ...
        if condition.name == "No_Filtering":
            ...
            try:
                paradigm_shifts, _ = detect_shift_signals(domain_data, domain_data.domain_name)
            finally:
    ...
    def create_visualizations(self, results_df: pd.DataFrame) -> None:
        ...
        output_dir = Path("experiment_results/experiment_3_visualizations")
    ...
    def save_results(self, results_df: pd.DataFrame, significance_results: Dict) -> Path:
        ...
        output_dir = Path("experiment_results/experiment_3")
        output_dir.mkdir(parents=True, exist_ok=True)
...
def main():
    """Run Experiment 3 with comprehensive analysis."""
