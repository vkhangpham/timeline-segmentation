...
class MultiSourceAblationExperiment:
    ...
    def create_visualizations(self, results_df: pd.DataFrame, evaluation_df: pd.DataFrame) -> None:
        ...
        output_dir = Path("experiment_results/experiment_1_visualizations")
    ...
    def save_results(self, results_df: pd.DataFrame, evaluation_df: pd.DataFrame, 
        ...
        output_dir = Path("experiment_results/experiment_1")
        output_dir.mkdir(parents=True, exist_ok=True)
...
def main():
    """Run Experiment 1 with comprehensive analysis including filtering mechanisms."""
    
    print("=" * 80)
    print("🧪 EXPERIMENT 1: MULTI-SOURCE SIGNAL CONTRIBUTION ANALYSIS")
    print("   Comprehensive Study Across 8 Research Domains")  
    print("=" * 80)
